...
#| label: fig-pipeline
library(here)
knitr::include_graphics(file.path(here("chapters","images/textclass_pipeline.png")))
```
...
knitr::include_graphics(file.path(here("chapters","images/model_architekur.png")))
```
